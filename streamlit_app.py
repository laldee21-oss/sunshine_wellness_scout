...
# Hero image - reliable tropical sunset beach
...
with cols[2]:
    ...
    st.image("https://image.shutterstock.com/image-photo/portrait-smiling-african-american-female-600w-2267904077.jpg", width=150)  # Option 2 - caring African American doctor
