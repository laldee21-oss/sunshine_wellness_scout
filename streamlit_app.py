...
# Florida-themed CSS (gradient restored)
st.markdown("""
<style>
    .stApp {
...
# Hero image - reliable sunset beach
...
with cols[2]:
    ...
    st.image("https://image.shutterstock.com/image-photo/portrait-smiling-african-american-female-600w-2267904077.jpg", width=150)  # Second choice - non-animated African American doctor
...
# === Agent Content ===
# (Full Fred, Greg, and Zoey code as before — Grok API active for all)
