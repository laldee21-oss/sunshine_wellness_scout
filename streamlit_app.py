...
with cols[1]:
    ...
    st.markdown("*PERSONAL TRAINER*  \nA motivated lifestyle coach. Let start with a tailored workout tailored to you fitness goals and health needs")
...
if st.session_state.selected_agent == "fred":
    ...
    st.success("**The report generated by this tool is completely free – no cost, no obligation!  You will recieve five total tailored recommendations.  The first two immediately. You will then recieve the full report via email**")
    st.write("Find the perfect Florida home that supports your lifestyle.")
